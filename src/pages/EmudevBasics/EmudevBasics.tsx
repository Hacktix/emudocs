...
export default function EmudevBasics() {
    return (
        ...
        <p>
            ...
            check out <a target="_blank" rel="noreferrer" href="https://en.wikipedia.org/wiki/Stack_(abstract_data_type)">the relevant Wikipedia article.</a>
        </p>
        <p>
        ...
        <p>
            ...
            can recommend <a target="_blank" rel="noreferrer" href="http://devernay.free.fr/hacks/chip8/C8TECH10.HTM">Cowgod's CHIP-8 Technical Reference</a> as
            well as <a target="_blank" rel="noreferrer" href="https://tobiasvl.github.io/blog/write-a-chip-8-emulator/">Tobias V. Langhoff's Guide to making a Chip-8 emulator</a>.
        </p>
        <p>
            ...
            the <a target="_blank" rel="noreferrer" href="https://computerarcheology.com/Arcade/SpaceInvaders/Hardware.html">Computer Archeology page on Space Invaders.</a>
        </p>
        <p>
            ...
            of the Gameboy on this site is also in the works, but <a target="_blank" rel="noreferrer" href="https://gbdev.io/pandocs/">The Gameboy Pandocs</a> are arguably the best source of
